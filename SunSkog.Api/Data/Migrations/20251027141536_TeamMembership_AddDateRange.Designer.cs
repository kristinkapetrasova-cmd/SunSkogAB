...
namespace SunSkog.Api.Data.Migrations
{
    ...
    [Migration("20251027141536_TeamMembership_AddDateRange")]
    partial class TeamMembership_AddDateRange
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SunSkog.Api.Storage.Entities.TeamMembership", b =>
                {
                    ...
                    b.HasIndex("TeamId", "UserId", "FromDate");
            ...
            modelBuilder.Entity("SunSkog.Api.Storage.Entities.ApprovalLog", b =>
                {
                    b.HasOne("SunSkog.Api.Storage.Entities.Timesheet", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SunSkog.Api.Storage.Entities.TeamMembership", b =>
                {
                    ...
                    b.HasOne("SunSkog.Api.Storage.Entities.Team", null)
                        .WithMany("Members")
